  ...
  return (
    <React.Fragment>
      ...
      <p>
        ...
        <strong>Terms</strong>
        &rdquo;) govern all use of our Service and together with the Privacy
        Policy constitutes your agreement with us (&ldquo;
      ...
      <p>
        ...
        identify you (&ldquo;
        <strong>Personal Data</strong>
        &rdquo;). Personally identifiable information may include, but is not
        limited to:
      </p>
      ...
      <p>
        ...
        permission to do so (&ldquo;
        <strong>Location Data</strong>
        &rdquo;). We use this data to provide features of our Service, to
      ...
      <hr />
      <p>
        Your information, including Personal Data, may be transferred to &ndash;
        and maintained on &ndash; computers located outside of your state,
      ...
      <p>
        ...
        shared, and to comply with this policy. &ndash; See more at:
      ...
      <ul>
        <li>
          <strong>To delete your personal information</strong>. If you make this
      ...
      <p>
        ...
        Service (&ldquo;
        <strong>Service Providers</strong>&rdquo;), provide Service on our
      ...
      <p>
        ...
        Privacy Policy page: https://circleci.com/privacy/.
      </p>
      <p></p>
      <ol>
        <li>
      ...
      <p>
        ...
        Add-on &ndash; https://tools.google.com/dlpage/gaoptout &ndash; for your
        web browser. Google Analytics Opt-out Browser Add-on provides visitors
      ...
      <p>
        ...
        prior to the change becoming effective and update &ldquo;effective
        date&rdquo; at the top of this Privacy Policy.
      </p>
      <p>
